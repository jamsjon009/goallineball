...
<header class="entry-header text-center clearfix">
    ...
    <?php
        ...
        $binduz_category_list = get_the_category_list( ', ' );
        if ( $binduz_category_list ) {
            echo '<span class="meta-categories post-cat">
               <i class="icon icon-folder"></i>
                  '. binduz_kaes( $binduz_category_list ).' 
               </span>';
        }
    ?>	
    </div>
    ...
    <div class="entry-content clearfix">
        <?php
            if( is_search() ){
                ...
                the_content( esc_html__( 'Continue reading &rarr;', 'binduz' ) );
            }
        ?>
...
wp_link_pages( array(
    'before' => '<div class="page-links">' . esc_html__( 'Pages:', 'binduz' ),
    'after'  => '</div>',
));
