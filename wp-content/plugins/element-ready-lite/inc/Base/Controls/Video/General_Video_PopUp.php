...
class General_Video_PopUp extends BaseController
{
	public function register() 
	{
		add_action('element_ready_section_general_video_popup_tab' , array( $this, 'settings_section' ), 10, 2 );
		add_action('element_ready_section_general_video_popup_tab_extra_control' , array( $this, 'settings_section_extra' ),10, 2 );
	}
    public function not_allowed_control($control,$widget){
       
        $widget_list = [
           'element_ready-post-slider' =>
                 ['show_date','show_cat','show_author','show_author_img','show_readmore','show_view_count']
       ];
        try{
	...
	public function settings_section( $ele,$widget ) 
	{
           ...
           $ele->start_controls_section(
            'section_general_tab',
                ...
                do_action( 'element_ready_section_general_video_popup_tab_extra_control', $ele, $widget );
