           ...
           $ele->start_controls_section(
            ...
            $ele->start_controls_section(
                'section_general_video_post_tab',
                    [
                        'label' => esc_html__('General Video Post', 'element-ready-lite'),
                        'condition' => [ 'block_style' => ['style1'] ]
                    ]
                );
                ...
                'video_post_title_crop',
                    [
                        'label'         => esc_html__( 'Video Post title crop', 'element-ready-lite' ),
                        'type'          => Controls_Manager::NUMBER,
                        'default'       => '8',
                    ]
                ); 
                ...
                $ele->add_control(
                    ...
                    [
                        'label'     => esc_html__('Show Trending icon', 'element-ready-lite'),
                        'type'      => Controls_Manager::SWITCHER,
                        'label_on'  => esc_html__('Yes', 'element-ready-lite'),
                        'label_off' => esc_html__('No', 'element-ready-lite'),
                        'default'   => 'no',
