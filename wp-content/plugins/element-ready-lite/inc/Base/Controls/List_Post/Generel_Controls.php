...
class Generel_Controls extends BaseController
{
	...
	{
	    add_action('element_ready_section_general_list_tab' , array( $this, 'settings_section' ), 10, 2 );
		add_action('element_ready_section_general_list_tab_extra_control' , array( $this, 'settings_section_extra' ),10, 2 );
	}
           ...
           $ele->start_controls_section(
            'section_general_tab',
               ...
               if($this->not_allowed_control('show_readmore',$widget)){
                ...
                do_action( 'element_ready_section_general_list_tab_extra_control', $ele, $widget );
