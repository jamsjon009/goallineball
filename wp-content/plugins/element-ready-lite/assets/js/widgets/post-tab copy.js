(function($) {
    ...
    var Element_Ready_Posts_Tabs_Script = function($scope, $) {
    ...
    $(window).on('elementor/frontend/init', function() {
        ...
        elementorFrontend.hooks.addAction('frontend/element_ready/element-ready-news-post-tab.default', Element_Ready_Posts_Tabs_Script);
