...
(function($) {
    ...
    TC_Class.prototype.getInstance = function(element) {
        ...
        if (typeof TC_Instance_List[cur_id] === "undefined") {
            ...
            var element_ready_options = $(element).data('options');
            if(typeof element_ready_options === "string") {
                element_ready_options = JSON.parse(element_ready_options);
            }
            if(typeof element_ready_options === "object") {
                options = $.extend(true, {}, this.options, element_ready_options);
            }
