    ...
    /----------------------------------------------------------*/
      var Binduz_Er_Post_Slider = function( $scope, $ ) {
         ...
         if($slider_box.length){
              ...
              var news_slider1 = $scope.find('.binduz-er-news-slider-item');
              var news_slider2 = $scope.find('.binduz-er-news-slider-content-slider');
